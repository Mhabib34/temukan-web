        ...
        <div className="flex items-center gap-2">
          {!isHydrated ? (
            ...
            <>
              <Link
                href="/notification"
                className="relative w-8 h-8 rounded-full flex items-center justify-center text-stone-500"
              >
                <Bell size={18} />
                {unreadCount > 0 && (
            ...
            <Link
              href="/login"
              className="h-7 px-3 rounded-full bg-orange-500 text-white text-xs font-semibold flex items-center"
            >
              Masuk
            </Link>
          )}
